...
If the orchestrator gave you a handover path (`~/.claude/handovers/...`), read that *after* the slice folder docs.
...
1. Write a handover file at `~/.claude/handovers/<task-slug>-<UTC-timestamp>.md` using this template:
