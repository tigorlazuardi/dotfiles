...
Ask via AskUserQuestion: **GitHub Pages** vs **Cloudflare Pages** (vs skip CI for now). Also ask, if the repo is private, whether the published site/`llms.txt` may be public — private-repo RAG access is a per-repo call.
