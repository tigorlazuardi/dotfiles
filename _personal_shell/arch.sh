...
alias mirror="sudo reflector --verbose -c indonesia,singapore -a 6 --sort rate --threads 16 --save /etc/pacman.d/mirrorlist --connection-timeout 10 --download-timeout 10 --protocol http,https && yay -Syy"
